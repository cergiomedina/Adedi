...
class PedidoEstadosControllerTest < ActionController::TestCase
  ...
  test "should create pedido_estado" do
    assert_difference('PedidoEstado.count') do
      post :create, pedido_estado: { est_pedido: @pedido_estado.est_pedido, id_est_pedido: @pedido_estado.id_est_pedido }
    end
  ...
  test "should update pedido_estado" do
    patch :update, id: @pedido_estado, pedido_estado: { est_pedido: @pedido_estado.est_pedido, id_est_pedido: @pedido_estado.id_est_pedido }
    assert_redirected_to pedido_estado_path(assigns(:pedido_estado))
  end
