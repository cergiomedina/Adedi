...
class TransicionArriendosControllerTest < ActionController::TestCase
  ...
  test "should create transicion_arriendo" do
    assert_difference('TransicionArriendo.count') do
      post :create, transicion_arriendo: { est_fin_arriendo: @transicion_arriendo.est_fin_arriendo, est_ini_arriendo: @transicion_arriendo.est_ini_arriendo }
    end
  ...
  test "should update transicion_arriendo" do
    patch :update, id: @transicion_arriendo, transicion_arriendo: { est_fin_arriendo: @transicion_arriendo.est_fin_arriendo, est_ini_arriendo: @transicion_arriendo.est_ini_arriendo }
    assert_redirected_to transicion_arriendo_path(assigns(:transicion_arriendo))
  end
