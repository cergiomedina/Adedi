...
class EjemplarEstadosControllerTest < ActionController::TestCase
  ...
  test "should create ejemplar_estado" do
    assert_difference('EjemplarEstado.count') do
      post :create, ejemplar_estado: { est_ejemplar: @ejemplar_estado.est_ejemplar, id_estado_cliente: @ejemplar_estado.id_estado_cliente }
    end
  ...
  test "should update ejemplar_estado" do
    patch :update, id: @ejemplar_estado, ejemplar_estado: { est_ejemplar: @ejemplar_estado.est_ejemplar, id_estado_cliente: @ejemplar_estado.id_estado_cliente }
    assert_redirected_to ejemplar_estado_path(assigns(:ejemplar_estado))
  end
