...
class VendedorEstadosControllerTest < ActionController::TestCase
  ...
  test "should create vendedor_estado" do
    assert_difference('VendedorEstado.count') do
      post :create, vendedor_estado: { est_vendedor: @vendedor_estado.est_vendedor, id_est_vendedor: @vendedor_estado.id_est_vendedor }
    end
  ...
  test "should update vendedor_estado" do
    patch :update, id: @vendedor_estado, vendedor_estado: { est_vendedor: @vendedor_estado.est_vendedor, id_est_vendedor: @vendedor_estado.id_est_vendedor }
    assert_redirected_to vendedor_estado_path(assigns(:vendedor_estado))
  end
