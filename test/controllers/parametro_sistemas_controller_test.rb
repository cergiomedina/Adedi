...
class ParametroSistemasControllerTest < ActionController::TestCase
  ...
  test "should create parametro_sistema" do
    assert_difference('ParametroSistema.count') do
      post :create, parametro_sistema: { id_parametro: @parametro_sistema.id_parametro, nombre_parametro: @parametro_sistema.nombre_parametro, valor_parametro: @parametro_sistema.valor_parametro }
    end
  ...
  test "should update parametro_sistema" do
    patch :update, id: @parametro_sistema, parametro_sistema: { id_parametro: @parametro_sistema.id_parametro, nombre_parametro: @parametro_sistema.nombre_parametro, valor_parametro: @parametro_sistema.valor_parametro }
    assert_redirected_to parametro_sistema_path(assigns(:parametro_sistema))
  end
