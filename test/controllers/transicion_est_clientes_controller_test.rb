...
class TransicionEstClientesControllerTest < ActionController::TestCase
  ...
  test "should create transicion_est_cliente" do
    assert_difference('TransicionEstCliente.count') do
      post :create, transicion_est_cliente: { est_fin_cliente: @transicion_est_cliente.est_fin_cliente, est_ini_cliente: @transicion_est_cliente.est_ini_cliente }
    end
  ...
  test "should update transicion_est_cliente" do
    patch :update, id: @transicion_est_cliente, transicion_est_cliente: { est_fin_cliente: @transicion_est_cliente.est_fin_cliente, est_ini_cliente: @transicion_est_cliente.est_ini_cliente }
    assert_redirected_to transicion_est_cliente_path(assigns(:transicion_est_cliente))
  end
