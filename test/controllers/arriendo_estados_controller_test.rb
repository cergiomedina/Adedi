...
class ArriendoEstadosControllerTest < ActionController::TestCase
  ...
  test "should create arriendo_estado" do
    assert_difference('ArriendoEstado.count') do
      post :create, arriendo_estado: { est_arriendo: @arriendo_estado.est_arriendo, id_est_arriendo: @arriendo_estado.id_est_arriendo }
    end
  ...
  test "should update arriendo_estado" do
    patch :update, id: @arriendo_estado, arriendo_estado: { est_arriendo: @arriendo_estado.est_arriendo, id_est_arriendo: @arriendo_estado.id_est_arriendo }
    assert_redirected_to arriendo_estado_path(assigns(:arriendo_estado))
  end
