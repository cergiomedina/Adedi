...
class TransicionEstPedidosControllerTest < ActionController::TestCase
  ...
  test "should create transicion_est_pedido" do
    assert_difference('TransicionEstPedido.count') do
      post :create, transicion_est_pedido: { est_fin_pedido: @transicion_est_pedido.est_fin_pedido, est_ini_pedido: @transicion_est_pedido.est_ini_pedido }
    end
  ...
  test "should update transicion_est_pedido" do
    patch :update, id: @transicion_est_pedido, transicion_est_pedido: { est_fin_pedido: @transicion_est_pedido.est_fin_pedido, est_ini_pedido: @transicion_est_pedido.est_ini_pedido }
    assert_redirected_to transicion_est_pedido_path(assigns(:transicion_est_pedido))
  end
