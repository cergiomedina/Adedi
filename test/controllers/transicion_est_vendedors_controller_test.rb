...
class TransicionEstVendedorsControllerTest < ActionController::TestCase
  ...
  test "should create transicion_est_vendedor" do
    assert_difference('TransicionEstVendedor.count') do
      post :create, transicion_est_vendedor: { est_fin_vendedor: @transicion_est_vendedor.est_fin_vendedor, est_ini_vendedor: @transicion_est_vendedor.est_ini_vendedor }
    end
  ...
  test "should update transicion_est_vendedor" do
    patch :update, id: @transicion_est_vendedor, transicion_est_vendedor: { est_fin_vendedor: @transicion_est_vendedor.est_fin_vendedor, est_ini_vendedor: @transicion_est_vendedor.est_ini_vendedor }
    assert_redirected_to transicion_est_vendedor_path(assigns(:transicion_est_vendedor))
  end
