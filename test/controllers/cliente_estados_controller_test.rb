...
class ClienteEstadosControllerTest < ActionController::TestCase
  ...
  test "should create cliente_estado" do
    assert_difference('ClienteEstado.count') do
      post :create, cliente_estado: { est_cliente: @cliente_estado.est_cliente, id_est_cliente: @cliente_estado.id_est_cliente }
    end
  ...
  test "should update cliente_estado" do
    patch :update, id: @cliente_estado, cliente_estado: { est_cliente: @cliente_estado.est_cliente, id_est_cliente: @cliente_estado.id_est_cliente }
    assert_redirected_to cliente_estado_path(assigns(:cliente_estado))
  end
