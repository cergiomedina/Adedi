class CategoriaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @categorium.save
        format.html { redirect_to @categorium, notice: 'La categoria fue satisfactoriamente creada.' }
  ...
  def update
    respond_to do |format|
      if @categorium.update(categorium_params)
        format.html { redirect_to @categorium, notice: 'La categoria fue satisfactoriamente actualizada.' }
  ...
  def destroy
    @categorium.destroy
    respond_to do |format|
      format.html { redirect_to categoria_url, notice: 'La categoria fue satisfactoriamente eliminada.' }
  ...
  private
    ...
    def categorium_params
      params.require(:categorium).permit(:id_categoria, :nombre_categoria, :stock_categoria)
    end
end
