class VendedorsController < ApplicationController
  ...
  private
    ...
    def vendedor_params
      params.require(:vendedor).permit(:nombre_vendedor, :apellido_vendedor, :rut_vendedor, :correo_vendedor, :direccion_vendedor, :telefono_vendedor, :estado_vendedor, :password_vendedor)
    end
end
